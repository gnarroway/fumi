...
(deftest ^:integration test-histogram
  ...
  (is (= [{:help    "hd"
    ...
    (is (= (clojure.string/join
            ...
            ["# HELP h hd"
             "# TYPE h histogram"
             "h_bucket{le=\"0.005\"} 0.0"
             "h_bucket{le=\"0.01\"} 0.0"
             "h_bucket{le=\"0.025\"} 0.0"
             "h_bucket{le=\"0.05\"} 0.0"
             "h_bucket{le=\"0.075\"} 0.0"
             "h_bucket{le=\"0.1\"} 1.0"
             "h_bucket{le=\"0.25\"} 1.0"
             "h_bucket{le=\"0.5\"} 1.0"
             "h_bucket{le=\"0.75\"} 1.0"
             "h_bucket{le=\"1.0\"} 2.0"
             "h_bucket{le=\"2.5\"} 2.0"
             "h_bucket{le=\"5.0\"} 2.0"
             "h_bucket{le=\"7.5\"} 2.0"
             "h_bucket{le=\"10.0\"} 2.0"
             "h_bucket{le=\"+Inf\"} 2.0"
             "h_count 2.0"
             "h_sum 1.1"
             ""
             "# HELP h2 hd2"
             "# TYPE h2 histogram"
             "h2_bucket{le=\"0.005\"} 0.0"
             "h2_bucket{le=\"0.01\"} 0.0"
             "h2_bucket{le=\"0.025\"} 0.0"
             "h2_bucket{le=\"0.05\"} 0.0"
             "h2_bucket{le=\"0.075\"} 0.0"
             "h2_bucket{le=\"0.1\"} 0.0"
             "h2_bucket{le=\"0.25\"} 0.0"
             "h2_bucket{le=\"0.5\"} 0.0"
             "h2_bucket{le=\"0.75\"} 0.0"
             "h2_bucket{le=\"1.0\"} 0.0"
             "h2_bucket{le=\"2.5\"} 0.0"
             "h2_bucket{le=\"5.0\"} 0.0"
             "h2_bucket{le=\"7.5\"} 0.0"
             "h2_bucket{le=\"10.0\"} 0.0"
             "h2_bucket{le=\"+Inf\"} 0.0"
             "h2_count 0.0"
             "h2_sum 0.0"
             ""])
           (-> (map without-created-sample (fc/collect)) (fc/serialize :text)))))
